...
namespace UserModule_INDEX_TRANSLATOR_V1_00
{
    public class UserModuleClass_INDEX_TRANSLATOR_V1_00 : SplusObject
    {
    ...
    public override void LogosSplusInitialize()
    {
        ...
        X = new InOutArray<AnalogInput>( 48, this );
        for( uint i = 0; i < 48; i++ )
        {
        ...
        OUTPUT = new InOutArray<AnalogOutput>( 48, this );
        for( uint i = 0; i < 48; i++ )
        {
    ...
    public UserModuleClass_INDEX_TRANSLATOR_V1_00 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
    
    
    
    
    const uint Y__AnalogSerialInput__ = 0;
    const uint X__AnalogSerialInput__ = 48;
